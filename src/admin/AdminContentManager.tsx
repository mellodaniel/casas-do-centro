  ...
  if (isLoadingContent) {
    return (
      <div className="admin-card">
        <span className="admin-kicker">Conteúdo do website</span>
        <h3>A carregar conteúdo...</h3>
        <p>A carregar textos e imagens guardados no Supabase.</p>
      </div>
    );
  }
            ...
            <div className="admin-two-fields">
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateHeroField('floatingCardTitle', event.target.value)
                  }
                />
              </label>
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateHeroField('floatingCardText', event.target.value)
                  }
                />
              </label>
            </div>
          ...
          <div id="sobre" className="admin-card">
            ...
            <label>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateAboutField('paragraphsText', event.target.value)
                }
              />
            </label>
          </div>
          ...
          <div id="modelos" className="admin-card">
            ...
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  updateModelsSectionField('title', event.target.value)
                }
              />
            </label>
            ...
            <label>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateModelsSectionField('description', event.target.value)
                }
              />
            </label>
                ...
                <div className="admin-repeat-item" key={`model-${index}`}>
                  ...
                  <label>
                    ...
                    <input
                      value={model.title}
                      onChange={(event) =>
                        updateModelItem(index, 'title', event.target.value)
                      }
                    />
                  </label>
                  ...
                  <label>
                    ...
                    <textarea
                      ...
                      value={model.text}
                      onChange={(event) =>
                        updateModelItem(index, 'text', event.target.value)
                      }
                    />
                  </label>
                </div>
          ...
          <div id="vantagens" className="admin-card">
            ...
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  updateBenefitsSectionField('title', event.target.value)
                }
              />
            </label>
            ...
            <label>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateBenefitsSectionField('description', event.target.value)
                }
              />
            </label>
                ...
                <div className="admin-repeat-item" key={`benefit-${index}`}>
                  ...
                  <label>
                    ...
                    <input
                      value={benefit.title}
                      onChange={(event) =>
                        updateBenefitItem(index, 'title', event.target.value)
                      }
                    />
                  </label>
                  ...
                  <label>
                    ...
                    <textarea
                      ...
                      value={benefit.text}
                      onChange={(event) =>
                        updateBenefitItem(index, 'text', event.target.value)
                      }
                    />
                  </label>
                </div>
          ...
          <div id="contactos" className="admin-card">
            ...
            <label>
              ...
              <textarea
                ...
                onChange={(event) =>
                  updateContactField('whatsappMessage', event.target.value)
                }
              />
            </label>
          </div>
