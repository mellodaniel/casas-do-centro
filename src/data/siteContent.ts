...
export const siteContent = {
  company: {
    name: 'Chalés do Centro - Casas de Madeira',
    shortName: 'Chalés do Centro',
    slogan: 'Chalés e casas de madeira confortáveis, sustentáveis e adaptáveis ao seu projeto.',
  },

  contact: {
    phone: '+351 912 345 678',
    email: 'geral@chalesdocentro.pt',
    location: 'Leiria, Portugal',
    whatsappNumber: '351912345678',
    whatsappMessage: 'Olá, gostaria de pedir informações sobre chalés e casas de madeira.',
  },
  ...
  hero: {
    ...
    highlights: [
      'Chalés e casas certificadas',
      'Madeira, conforto e sustentabilidade',
      'Portugal Continental - Zona Centro',
      'Ajustes conforme disponibilidade',
    ],
    imageAlt: 'Chalé de madeira em ambiente natural',
    floatingCardTitle: 'Conforto natural',
    floatingCardText: 'Madeira, design e qualidade',
  },

  about: {
    label: 'Sobre nós',
    title: 'Chalés de madeira com conforto, sustentabilidade e confiança.',
    paragraphs: [
      'A Chalés do Centro nasce para apresentar soluções em madeira para diferentes formas de viver, descansar, investir ou criar um refúgio com ligação à natureza.',
      'Os nossos chalés e casas de madeira são pensados para quem valoriza conforto, sustentabilidade, design acolhedor e materiais de qualidade, respeitando sempre os modelos e opções disponíveis em fábrica.',
  ...
  models: [
    {
      ...
      text: 'Chalés e casas de madeira pensados para viver com conforto, funcionalidade e qualidade durante todo o ano.',
    },
    {
      icon: Leaf,
  ...
  benefitsSection: {
    label: 'Vantagens',
    title: 'Porquê escolher um chalé de madeira?',
    description:
      'Os chalés e casas de madeira são uma escolha natural para quem procura sustentabilidade, conforto, estética diferenciadora e materiais de qualidade.',
  },

  benefits: [
    {
      icon: Award,
      title: 'Soluções certificadas',
      text: 'Projetos desenvolvidos com materiais de qualidade e certificações adequadas, conforme os modelos e fornecedores disponíveis.',
    },
    {
      icon: Leaf,
      title: 'Ecológicos e sustentáveis',
  ...
  ideal: {
    ...
    description:
      'As soluções em madeira adaptam-se a diferentes necessidades, desde habitação permanente até turismo rural, lazer ou investimento.',
    items: [
      'Habitação própria',
      'Casa de férias',
      'Turismo rural',
  ...
  process: {
    label: 'Processo',
    title: 'Da ideia à proposta do seu chalé de madeira.',
    steps: [
      {
        number: '1',
      ...
      },
      {
        number: '2',
        title: 'Análise',
        text: 'Avaliamos tipo de solução, área, finalidade e características pretendidas.',
      },
      {
        number: '3',
  ...
  gallery: {
    label: 'Galeria',
    title: 'Inspire-se para o seu futuro chalé de madeira.',
    description:
  ...
  faq: {
    ...
    items: [
      {
        question: 'Um chalé ou casa de madeira precisa de licenciamento?',
        answer:
          'Na maioria dos casos, sim. Em Portugal, uma solução destinada a habitação ou utilização permanente normalmente deve cumprir regras urbanísticas e procedimentos junto da Câmara Municipal. Cada caso deve ser analisado de acordo com o terreno e finalidade do projeto.',
      },
      {
        question: 'As casas são totalmente feitas à medida?',
        answer:
          'Por norma, as soluções partem de modelos definidos pela fábrica. Podem existir alterações de tipologia, áreas e algumas características, mas tudo depende da disponibilidade da fábrica. Projetos muito específicos ou exclusivos podem ter impacto no valor final.',
      },
      {
      ...
      {
        question: 'As soluções são certificadas e ecológicas?',
        answer:
      ...
      {
        question: 'Podem ser usadas para habitação permanente?',
        answer:
          'Sim. Os chalés e casas de madeira podem ser pensados para habitação permanente, casas de férias, turismo rural, alojamento local ou outros fins, desde que o projeto seja adequado à finalidade pretendida e cumpra os requisitos aplicáveis.',
      },
      {
  ...
  contactSection: {
    ...
    description:
      'Fale connosco e dê o primeiro passo para avaliar a solução em madeira mais adequada ao seu objetivo.',
    formNote:
      'Os seus dados são confidenciais. A consulta inicial é gratuita e sem compromisso.',
  },

  footer: {
    copyright: '© 2026 Chalés do Centro - Casas de Madeira. Todos os direitos reservados.',
  },
};
